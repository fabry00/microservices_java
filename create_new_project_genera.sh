...
PACKAGE=$3
/f/apache-maven-3.3.9/bin/mvn archetype:generate -DgroupId=$GROUPID -DartifactId=$ARTIFACTID -Dname=$DNAME -Dpackage=$PACKAGE -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false -e
